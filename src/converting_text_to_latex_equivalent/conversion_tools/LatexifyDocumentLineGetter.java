...
public class LatexifyDocumentLineGetter {
    ...
    private DocumentLineOut handleHeadingLine(String line, StringBuilder textBuilder, String previousBulletStyle)
    {
        makeLineALatexHeading(line, textBuilder);
    ...
    private StringBuilder makeLineALatexHeading(String line, StringBuilder textBuilder)
    {
